...
df2.bleach <- droplevels(df2.bleach)
...
# Autocorrelation Dates: using ar1() despite uneven dates because ou() ran into convergence problems
...
# Final model results
car::Anova(beta.all.nes.ar)
summary(beta.all.nes.ar)
